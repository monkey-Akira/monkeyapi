...
const defaultBillingSettings: BillingSettings = {
  ...
  'empty_response_refund_setting.mode': 'off',
  'empty_response_refund_setting.models': '[]',
  'empty_response_refund_setting.custom_response_enabled': false,
  'empty_response_refund_setting.custom_response_text': '',
  QuotaPerUnit: 500000,
  USDExchangeRate: 7,
