...
export const STATIC_I18N_KEYS = [
  ...
  'Filter by channel',
  'All enabled models',
  'Search and select existing models',
  'No matching models',
  ...
  'Empty response automatic refund',
