	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/risk_alerts", controller.GetUserRiskAlerts)
				adminRoute.GET("/risk_alerts/:id", controller.GetUserRiskAlert)
				adminRoute.PUT("/risk_alerts/:id", controller.UpdateUserRiskAlertStatus)
